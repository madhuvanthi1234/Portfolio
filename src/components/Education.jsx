...
const education = [
    ...
    },
    {
      ...
      institution: "Government Higher Secondary School(Kanjikovil)",
      year: "2020 - 2022",
      description: "I successfully completed my 11th & 12th standard at GHSS with excellence.",
      icon: "🎓",
    },
    {
      degree: "Secondary (10th)",
      institution: "Mahidar Academy High School(Nandagiri)",
      year: "2020",
  ...
  const experience = [
    ...
    {
      role: "AI (Internship)",
      company: "Galvin Technology",
      year: "2024",
      description: "Developed and optimized AI application, enhancing user experience.",
      icon: "💻",
    },
  ];
