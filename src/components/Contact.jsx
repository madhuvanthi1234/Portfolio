        ...
        <div className="flex flex-col justify-center space-y-8 text-center">
          <div>
            ...
            <p className="text-gray-600 mt-2">
              <a href="mailto:madhuvanthi272005@gmail.com" className="text-blue-500 hover:underline">
                madhuvanthi272005@gmail.com
              </a>
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-600 mt-2">
              <a href="tel:+916381968005" className="text-blue-500 hover:underline">
                +91 6381968005
              </a>
            </p>
          </div>
          <div>
            ...
            <div className="flex gap-3 justify-center text-2xl transition-all mt-5">
              <a href="https://github.com/madhuvanthi1234" target="_blank" rel="noopener noreferrer">
                <FaGithub className="text-blue-400 hover:text-blue-500" />
              </a>
              <a href="https://www.hackerrank.com/profile/madhuvanthi27201" target="_blank" rel="noopener noreferrer">
                <FaHackerrank className="text-blue-400 hover:text-pink-500" />
              </a>
              <a href="https://www.linkedin.com/in/madhuvanthi-j-s-0b28b1290/" target="_blank" rel="noopener noreferrer">
                <FaLinkedin className="text-blue-400 hover:text-blue-700" />
              </a>
              <a href="https://leetcode.com/u/Madhuvanthi1234/" target="_blank" rel="noopener noreferrer">
