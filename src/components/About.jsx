...
const About = () => {
  const handleEmailClick = () => {
    const email = "madhuvanthi272005@gmail.com"; 
    const subject = "Let's Connect"; 
    const body = "Hello Madhuvanthi, I'd like to get in touch with you."; 
      ...
      <div className='max-w-7xl mx-auto px-4'>
        ...
        <div className='flex flex-col md:flex-row gap-20 items-center'>
          ...
          <div className='p-5 md:p-10 bg-gray-950 rounded-md shadow-[0px_0px_20px_10px_rgba(0,0,0,0.3)] shadow-blue-500'>
            <p className='text-lg leading-7 mb-6'>Hi! I'm Madhuvanthi, I am a passionate Java Developer with a strong foundation in data structures and a keen interest in software development. My expertise lies in backend technologies like SQL, MongoDB, and React, enabling me to create robust, scalable, and user-friendly applications.</p>
